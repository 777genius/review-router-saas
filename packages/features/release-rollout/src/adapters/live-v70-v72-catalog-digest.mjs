    ...
    'history',CASE WHEN reviewrouter_activation.read_activation_migration_manifest_identity()
      ...
      THEN jsonb_build_array(
        ...
        jsonb_build_object('name','000089_codex_oauth_v4_v5_staged_compatibility',
          ...
          'finished',true,'rolledBack',false),
        jsonb_build_object('name','000089_workflow_provisioning_writer_quiescence',
          'checksum','92496088bff5e074c19a74a5a9dacdc38cb8794fac0abec605121eb3b61b29f8',
          'finished',true,'rolledBack',false),
        jsonb_build_object('name','000090_workflow_provisioning_attempt_authority',
          'checksum','ca3fbbdc19b72ac75c0b31a5ddae887028191ec8c333b769853fc88f2cf37a49',
          'finished',true,'rolledBack',false),
        jsonb_build_object('name','000091_workflow_provisioning_artifact_and_inventory',
          'checksum','086a7e2a38e1c3fa67ba44edcdac198af46327fd380eaeb2d13849ac6d22a562',
          'finished',true,'rolledBack',false))
      ELSE '[]'::jsonb END,
