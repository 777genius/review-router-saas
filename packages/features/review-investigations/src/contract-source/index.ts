...
export const reviewInvestigationsActionContractFragment = Object.freeze({
  ...
  publishedEnums: Object.freeze([
    ...
    Object.freeze({
      typeName: "ReviewInvestigationLeaseResultStatus",
      values: Object.freeze([
        "acquired",
        "restored",
        "applied",
  ...
  operations: Object.freeze([
    ...
    Object.freeze({
      ...
      requestTypeName: "ReviewInvestigationOpenV2Request",
      resultTypeName: "ReviewInvestigationOpenV2Result",
      callerAuthority: "run_authorization",
      mutability: "command",
      naturalIdempotencyPreimage: Object.freeze([
        "execution_id",
      ...
      requestFields: Object.freeze([
        ...
        Object.freeze({ name: "investigationManifestHash", type: "hash" }),
      ]),
      resultStatusEnum: "ReviewInvestigationOpenResultStatus",
      resultFields: commonResultFields,
    }),
    ...
    Object.freeze({
      ...
      requestTypeName: "ReviewInvestigationLeaseAcquireRequest",
      resultTypeName: "ReviewInvestigationLeaseAcquireResult",
      callerAuthority: "run_authorization",
      mutability: "command",
      naturalIdempotencyPreimage: Object.freeze([
        "investigation_id",
      ...
      resultStatusEnum: "ReviewInvestigationLeaseResultStatus",
      resultFields: Object.freeze([
    ...
    ...["renew", "release"].map((transition) =>
      Object.freeze({
        operationId: `review_investigation_lease_${transition}`,
        requestTypeName: `ReviewInvestigationLease${transition === "renew" ? "Renew" : "Release"}Request`,
        resultTypeName: `ReviewInvestigationLease${transition === "renew" ? "Renew" : "Release"}Result`,
    ...
    Object.freeze({
      ...
      requestTypeName: "ReviewInvestigationReplayRequest",
      resultTypeName: "ReviewInvestigationReplayResult",
      callerAuthority: "run_authorization",
      mutability: "command",
      naturalIdempotencyPreimage: Object.freeze([
      ...
      requestFields: Object.freeze([
        Object.freeze({ name: "authorizationId", type: "identifier" }),
        Object.freeze({ name: "sourceInvestigationId", type: "identifier" }),
        Object.freeze({ name: "sourceCertificateHash", type: "hash" }),
        Object.freeze({ name: "targetExecutionId", type: "identifier" }),
        Object.freeze({ name: "targetWorkSlotId", type: "identifier" }),
        Object.freeze({ name: "stableReviewUnitKey", type: "identifier" }),
        Object.freeze({ name: "providerVoteLaneId", type: "identifier" }),
        ...
        Object.freeze({ name: "targetScopeHash", type: "hash" }),
        Object.freeze({
        ...
        Object.freeze({ name: "replayProofsHash", type: "hash" }),
      ]),
      resultStatusEnum: "ReviewInvestigationMutationResultStatus",
      resultFields: commonResultFields,
    }),
    Object.freeze({
      ...
      requestTypeName: "ReviewInvestigationReplayV2Request",
      resultTypeName: "ReviewInvestigationReplayV2Result",
      callerAuthority: "run_authorization",
      mutability: "command",
      naturalIdempotencyPreimage: Object.freeze([
        "source_investigation_id",
