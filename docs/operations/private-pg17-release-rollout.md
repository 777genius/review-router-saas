...
The promoted trust root is generated from the independently reviewed v25
...
```bash
REVIEW_ROUTER_ACTIVATION_CATALOG_PROMOTION=promote-reviewed-activation-catalog-v25 \
  pnpm release-rollout:promote-activation-catalog-policy \
  --candidate /secure/evidence/rr-activation-catalog-candidate-v25.json --write
```
