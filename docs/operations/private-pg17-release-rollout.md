...
The promoted trust root is generated from the independently reviewed v23
...
```bash
REVIEW_ROUTER_ACTIVATION_CATALOG_PROMOTION=promote-reviewed-activation-catalog-v23 \
  pnpm release-rollout:promote-activation-catalog-policy \
  --candidate /secure/evidence/rr-activation-catalog-candidate-v23.json --write
```
