...
The promoted trust root is generated from the independently reviewed v22
...
```bash
REVIEW_ROUTER_ACTIVATION_CATALOG_PROMOTION=promote-reviewed-activation-catalog-v22 \
  pnpm release-rollout:promote-activation-catalog-policy \
  --candidate /secure/evidence/rr-activation-catalog-candidate-v22.json --write
```
