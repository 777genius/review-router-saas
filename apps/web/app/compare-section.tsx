...
const competitorRows = [
  ...
  },
  {
    ...
    executionDetail: "Runs in vendor infrastructure",
    codePath: "Review context handled by vendor cloud",
    bestFit: "Fast PR review setup for most teams",
    control: "Medium",
    controlDetail: "SaaS controls and retention settings",
  },
  {
    product: "Qodo Merge",
    mark: "QM",
