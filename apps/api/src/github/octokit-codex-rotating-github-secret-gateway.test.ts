...
describe("OctokitCodexRotatingGitHubSecretGateway", () => {
  ...
  it.each([
    [CodexRotatingT0WorkflowSchemaVersion.VersionedSecretNamespaceV4, false],
    [CodexRotatingT0WorkflowSchemaVersion.CertifiedForkReviewV5, true],
  ] as const)(
    "publishes and preserves schema V%s with the exact next namespace",
    async (workflowSchemaVersion, forkAgenticSandboxEnabled) => {
