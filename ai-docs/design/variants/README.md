...
These are static direction mockups for the ReviewRouter dashboard. The selected variant should become the visual source of truth for the next UI implementation pass.

## Variant 1 - Neon Ops Cockpit
...
## Variant 2 - Holographic Terminal Grid
