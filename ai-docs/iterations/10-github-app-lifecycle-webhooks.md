...
- Existing GitHub installation updates preserve the original workspace id when account login changes, so configs/audit/repositories are not split across a replacement workspace.
